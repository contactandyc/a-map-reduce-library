...
int main(int argc, char **argv) {
    ...
    // FIX: Using the newly integrated struct correctly to maintain zero-shuffle
    inv_freq_config_t cfg = { .min_overlap = 3, .out_mode = INV_FREQ_OUT_A_WDESC };
    ...
    // Plug in the Substitutes Module!
