...
COPY --chown=dev:dev . /workspace/a-map-reduce-library
RUN mkdir -p /workspace/build/a-map-reduce-library && \
    cd /workspace/build/a-map-reduce-library && \
    cmake /workspace/a-map-reduce-library && \
